...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/0HugoHu/hugowebtools',
      category: 'External',
      description: 'View the source code of HugoTools on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve HugoTools.',
      href: 'https://github.com/0HugoHu/hugowebtools/issues',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about HugoTools.',
      to: '/about',
      category: 'Pages',
